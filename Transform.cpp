...
// Implements standard axis-angle formula to create rotation matrix. 
...
mat4 Transform::lookAt(vec3 eye, vec3 up) {
  ...
  mat4 M = mat4(u.x,v.x,w.x,0,u.y,v.y,w.y,0,u.z,v.z,w.z, 
                0, (-u.x*eye.x-u.y*eye.y-u.z*eye.z), 
                (-v.x*eye.x-v.y*eye.y-v.z*eye.z), 
                (-w.x*eye.x-w.y*eye.y-w.z*eye.z), 1);
